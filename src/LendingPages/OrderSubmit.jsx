...
const OrderComponent = forwardRef((props, ref) => {
    const unitPrice = 999; // প্রতি পণ্যর মূল্য
            ...
            <div className="row">
                ...
                <div className="col-md-4 mb-4">
                    <div className="product-summary p-3 border rounded">
                        <h3>
                            জৈব ও ভার্মি মিক্সড পায়েল সার = <span>{quantity}</span>
                        </h3>
                ...
                <div className="col-md-4 mb-4">
                    <div className="billing-details p-3 border rounded">
                        ...
                        <form>
                            ...
                            <button type="submit" className="btn btn-primary w-100" style={{ backgroundColor: '#3F9E53' }}>
                ...
                <div className="col-md-4 mb-4">
                    <div className="order-summary p-3 border rounded">
                        <h3>Your order</h3>
                        <p>Product: জৈব ও ভার্মি মিক্সড পায়েল সার = <span>{quantity}</span></p>
